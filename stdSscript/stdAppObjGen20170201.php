	...
	<div >	
		...
		<div class=" {$classSetOn}" onmouseover="A_Scope.initModels();">
			<span ng-click="{$fieldName}='1';" class="ab-pointer {$this->inAttrib['class']} ab-border ab-spaceless">
				<span class="" >
					<input type="button"   value="No " style="background-color:white;" class=" ab-spaceless " onblur="$(this).val('No ');"  /> 
				</span>
		...
		<div class=" {$classSetOff} " onmouseover="A_Scope.initModels();">
			<span ng-click="{$fieldName}='0';" class="ab-pointer {$this->inAttrib['class']} ab-border ab-spaceless">
				<span class=" " >
					<input type="button"  value="Yes "  style="background-color:white;" class=" ab-spaceless " onblur="$(this).val('Yes ');"  /> 
				</span>
...
<div neg-if="ABsearchTbl=='{$searchTable}'" >
	<div>

	<form>
		<table style="width:100%;" ng-init="ABgetLabels();ABrangeFilters('ABsPattern');">
			<tr>
	...
	<div id="ABSTDATA{$searchTable}"  style="position:fixed;left:30px;z-index:1;" class="row hidden ab-border well"  >
	<table class="{$searchFilter} ab-strong ab-container" >
		<tr>
			<td class="text-success ab-strong ab-spaceless btn btn-md" >
				...
				<span class="{{ABrangeSubmit==true?'':'hidden'}} " >
					<span 	onclick="$('#ABSTDATA{$searchTable}').toggleClass('hidden');"
						ng-click="ABsearchSubmit('ABsPattern');ABsetCurTable('');" 
			...
			<td style="padding-left:5px;padding-right:5px;min-width:100px;">
				...
				<tr>
				<td>
				<input class="hidden" ng-model="ABcurTable" ng-init="ABcurTable=''" />
				<ul class="nav nav-tabs">
				  <li class="dropdown" style="padding-left:5px;" >
				    <span class="dropdown-toggle btn btn-success btn-sm ab-spaceless" data-toggle="dropdown">
				    	Table
				    	<span class="caret"></span>
				    </span>
				    <ul class="dropdown-menu" >
				      <li ng-repeat="tbls in searchTable" >
				      	<span class="text-primary btn-link ab-pointer" ng-click="ABsetCurTable(tbls.tblInfo.tblName);" style="white-space:nowrap;padding:0px;" >
				...
				<td class="text-right">
					<span 
						class="btn btn-success btn-sm ab-spaceless {{ABcurTable!=''?'':'hidden'}}" 
						ng-click="ABsetCurTable('');">
					&nbsp;X&nbsp
					</span>
				</td>
				</tr>
		...
		<tr class="ab-container">
			<td  style="padding-top:5px;vertical-align:top;">
				<div class="ab-wrapper-div"
					id="{{ABsearchTbl=='{$searchResult}'?'ABrangeTable':''}}"
				 >
				</div>
			</td>
			...
			<td   style="padding-left:15px;vertical-align:top;" >	
				...
				<div ng-repeat="tables in searchTable"  
				class="{{tables.tblInfo.tblName==ABcurTable?'':'hidden'}} ab-border ab-wrapper-div "  >
					<span class="well" style="white-space:nowrap;padding:0px;" >
						{{tables.tblInfo.tblComment}}
					</span>
					
					<div class="ab-spaceless"ab-border ab-spaceless" 
						ab-searchid="{{fields.name}}"
						ng-click="ABrangeTable(fields.name,fields.comment,fields.type,tables.tblInfo.tblComment);"
