...
<span>
<input class="hidden" id="VGB_SUPPsearch" ng-click="initNewCustomer();" />
<a class="ab-pointer" 
...
$hardCode .= '<td style="vertical-align:top;" ><label class="text-primary"  ab-label="STD_TEXT_LINE" >Text Line</label>:<textarea style="overflow:hidden;font-size:9pt;" rows="4" cols="30"  ng-model="VPU_ORHE_ORTXT"  > </textarea></td><td>&nbsp;&nbsp;&nbsp;</td>';
...
//		$hardCode = $xtmp->setListerField($keepOrg,$repeatIn,$searchIn,$refName,$refModel,$searchInRef,$searchRefDesc,$repeatInRef,$refDesc,$refDetail,$refDetailLink,$ignTrig);
//		$xtmp->setFieldWrapper("view01","2.140","vpu_orhe","VPU_ORHE_SLSRP","",$grAttr,$laAttr,$inAttr,$hardCode);
//	   echo $xtmp->currHtml;
//			
