...
$orderAddressDisplay = <<<EOB
        ...
        <tr 	ng-repeat="add in rawResult.vgb_addr  | AB_noDoubles:'idVGB_ADDR' " 
        	ng-if="add.idVGB_ADDR==VPU_ORHE_BTADD"
        >
        	<td style="text-align:left;white-space:nowrap;">
        		...
        		<td style="vertical-align:top;">
       			...
       			<span ab-label='STD_PAY_TO' class='small text-primary'>Bill</span>
        ...
        <tr class="ab-border" ><td></td></tr>
         ...
         <tr 	ng-repeat="add in rawResult.vgb_addr | AB_noDoubles:'idVGB_ADDR' " 
        	ng-if="add.idVGB_ADDR==VPU_ORHE_STADD"  mmm="&& add.VGB_ADDR_BPART!=AB_CPARM.VGB_COMPANY.vgb_bpar.idVGB_BPAR"
        >
        	<td style="text-align:left;white-space:nowrap;" >
        		<table style="width:100%;">
        		<tr>
...
<!--
         <tr 	ng-repeat="add in AB_CPARM.VGB_COMPANY.vgb_addr | AB_noDoubles:'idVGB_ADDR' " 
        	ng-if="add.idVGB_ADDR==VPU_ORHE_STADD"
        >
        	<td style="text-align:left;white-space:nowrap;">
        		<table style="width:100%;">
        		<tr>
...
{
	// $("#ab-back").click(); 
	location.href="#VPU_ORDERS/VPU_ORDERS/Process:VPU_ORDERS,Session:VPU_ORDERS,tblName:vpu_orhe";
}
else
{
		...
		<div class="row ">
			...
			<div class="col-sm-12">
				<div class="row vslFormPg1 hidden ab-strong" >
					<div class="col-sm-2  well ab-spaceless ">
						<span  class="text-primary" ab-label="STD_ORNUM"></span>
						<span class="ab-strong ">:&nbsp;{{VPU_ORHE_ORNUM}}</span>
					</div>
					<div class="col-sm-3  well ab-spaceless ">
						<ul class="nav nav-pills ab-spaceless  ab-pointer" role="tablist" ng-init="initAllocDashBoard()" >
							<li class="dropdown ab-spaceless {{stepRetract!=true?'':'bg-danger'}} " style="width:100%;">
								<span class="dropdown-toggle " data-toggle="dropdown" style="white-space:nowrap;padding:0px;">
									...
									<span  class="text-primary" ab-label="VGB_SUPP_PTADD"></span>
									<span class="ab-strong">:&nbsp;{{ VGB_BPAR_BPART }}&nbsp;-&nbsp;{{ VGB_SUPP_BPNAM }}</span>
	...
	<div class="col-sm-6   {{vslFormPg==2?'':'invisible'}}" style="margin-left:5px;" >
		<div class="row well ab-spaceless " style="font-weight:900;border-color:RoyalBlue;padding-top:3px;padding-bottom:3px;" >
			...
			<div  class="col-sm-2  text-left small text-primary  "    >
				...
				<li class="bg-warning" ng-repeat="docs in vsl_orheOrsi[0].rowSet | AB_noDoubles:'idVPU_ORSI' | AB_Sorted:'VPU_ORSI_STEPS'"  ng-if="docs.VPU_ORSI_ORNUM==idVPU_ORHE" >
			...
			<span class="hidden" data-toggle="modal" data-target="#ORHE_ALLOC" ng-init="vin_inveQuery=''" >GO</span>
				...
				<ul class="dropdown-menu ab-spaceless" role="menu"   ng-init="selectCurrentForm();">
				<li class="bg-warning" ng-repeat="docs in rawResult.vpu_orheOrsi | AB_noDoubles:'idVPU_ORSI' | AB_Sorted:'VPU_ORSI_STEPS'"  ng-if="docs.VPU_ORSI_ORNUM==idVPU_ORHE" >
...
<div class="row  ">
			...
			<div class="col-sm-3  ac vslFormPg0 ">

				<input  class="hidden" ab-btrigger="vpu_orhe" ng-model="idVPU_ORHE" /> 
				<input  class="hidden" size=2 ng-model="VPU_ORHE_UPDCOUNT" /> 
...
<input class="hidden" id="orgUser" ng-model="orgUser"  />
		...
		<span 
			ng-repeat="usr in vsl_users"  ng-if="VPU_ORHE_USLNA==usr.CFG_USERS_CODE" org="{{VPU_ORHE_USLNA}}" onclick="if($('#orgUser').val().length ==0){deflectVal($(this).attr('org'),'orgUser');};" 
		>
		        	&nbsp;&nbsp;
		...
		<li class="bg-warning" 
			ng-repeat="usr in vsl_users"  ng-if="VPU_ORHE_USLNA!=usr.CFG_USERS_CODE"
		>
...
<select  class="ab-pointer" ng-init="getUsers();"
      ...
      ng-options="usr.CFG_USERS_CODE as usr.CFG_USERS_DESIGNATION for usr in vsl_users " 
      ng-model="orhe_user"  >
<option  value=""> No User</option>
</select>			
</strong>
-->
<span neg-init="getUsers();" ></span>
...
neg-click="ABsessionLink('#/VGB_PARTNERS/VGB_PARTNERS/Process:VGB_PARTNERS,Session:VGB_PARTNERS,tblName:vgb_supp,SourceProcess:VPU_ORDERS','#VGB_SUPPsearch');" >
...
$harderCode = <<<EOB
        ...
        <tr class="ab-border"><td></td></tr>
         ...
         <tr 	ng-repeat="add in rawResult.vgb_addr | AB_noDoubles:'idVGB_ADDR' " 
        	class="{{add.idVGB_ADDR==VPU_ORHE_STADD?'':'hidden'}}" 
        >
        	<td style="text-align:left;white-space:nowrap;">
        		<table style="width:100%;">
        		<tr>
			...
			<tr>
			<td colspan=3>
			<span ab-label="STD_CHANGE">Change</span>
			<span ab-label="STD_SHIP_TO">Ship</span>
			
<span>
<input class="hidden" id="VGB_SHIP_CUST" ng-click="initShipCustomer();" />
<a class="ab-pointer ab-border ab-spaceless small" 
ng-click="ABsearchTbl='vgb_cust';ABsessionLink('','#VGB_SHIP_CUST','vgb_cust');" 
neg-click="ABsessionLink('#/VGB_PARTNERS/VGB_PARTNERS/Process:VGB_PARTNERS,Session:VGB_PARTNERS,tblName:vgb_cust,SourceProcess:VPU_ORDERS','#VGB_SHIP_CUST');" >
<span ab-label="STD_SEARCH"></span>
<span ab-label="VGB_PARTNERS_vgb_cust"></span>
</a>
</span>
&nbsp;
<span>
<input class="hidden" id="VGB_SHIP_SUPP" ng-click="initShipSupplier();" />
<a class="ab-pointer ab-border ab-spaceless small" 
ng-click="ABsearchTbl='vgb_supp';ABsessionLink('','#VGB_SHIP_SUPP','vgb_supp');" 
neg-click="ABsessionLink('#/VGB_PARTNERS/VGB_PARTNERS/Process:VGB_PARTNERS,Session:VGB_PARTNERS,tblName:vgb_supp,SourceProcess:VPU_ORDERS','#VGB_SHIP_SUPP');" >
<span ab-label="STD_SEARCH"></span>
...
EOB;
	...
	$hardCode = "<table  class='small'><tr><td ab-label='VGB_SUPP_PTADD' class='small text-primary' style='white-space:nowrap;width:40px;max-width:50px;font-size:small;'>Bill to:</td><td>:</td><td>" . $harderCode . "</td></tr></table>"; 	
        	...
        	<td>
        		<table class="table" style="width:100%;" >
        			<tr>
        				...
        				<span ab-label="VGB_SUPP_PTADD">Bill To</span>&nbsp;&nbsp;-&nbsp;
        				Ship To&nbsp;
        				</td>
	        		...
	        		ng-if="ad.VGB_ADDR_BPART == idVGB_BPAR" >	
	        			...
	        			<td >
	        				...
	        				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	        				<input type="radio" class="hidden" checked name="stcust" ng-if="ad.idVGB_ADDR==VPU_ORHE_STADD" />
	        				
	        				<input type="radio"  class="hidden" rval='{{ad.idVGB_ADDR}}' pval="{{ad.VGB_ADDR_BPART}}" onclick="deflectVal($(this).attr('pval'),'VPU_ORHE_STCUS');deflectVal($(this).attr('rval'),'VPU_ORHE_STADD');" name="stcust" ng-if="ad.idVGB_ADDR!=VPU_ORHE_STADD" />
	        		...
	        		ng-if="ad.VGB_ADDR_BPART != idVGB_BPAR" >	
	        			...
	        			<td >
	        				<input type="radio" class="invisible" ng-if="ad.idVGB_ADDR==VPU_ORHE_BTADD" />
	        				<input type="radio" class="invisible" onclick="deflectVal($(this).attr('rval'),'VPU_ORHE_BTADD');"  ng-if="ad.idVGB_ADDR!=VPU_ORHE_BTADD" />
	        				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	        				<input type="radio" checked name="stdddcust" ng-if="ad.idVGB_ADDR==VPU_ORHE_STADD" />
	        				<input type="radio" rval='{{ad.idVGB_ADDR}}' pval="{{ad.VGB_ADDR_BPART}}" onclick="deflectVal($(this).attr('pval'),'VPU_ORHE_STCUS');deflectVal($(this).attr('rval'),'VPU_ORHE_STADD');" name="stdddcust" ng-if="ad.idVGB_ADDR!=VPU_ORHE_STADD" />
...
$hardCode .= '<td style="vertical-align:top;" ><label class="text-primary"  ab-label="STD_TEXT_LINE" >Text Line</label>:</td><td><textarea style="overflow:hidden;font-size:9pt;" rows="4" cols="30"  ng-model="VPU_ORHE_ORTXT"  > </textarea></td><td>&nbsp;&nbsp;&nbsp;</td>';

$hardCode .= '</tr></table>';
$xtmp->setFieldWrapper("view01","0.122","vsl_orhe","VPU_ORHE_ORTEXT","",$grAttr,$laAttr,$inAttr,$hardCode);
echo $xtmp->currHtml;			
...
echo '</div><div class="col-sm-3   vslFormPg0 "  >';
...
//	echo '</div><div class="col-sm-2   vslFormPg0  "  >';
	...
	$inAttr = $xtmp->inAttrib;
	$hardCode =  $xtmp->setEnumField('vpu_orhe','VPU_ORHE_PRLEV');
	$xtmp->setFieldWrapper("view01","2.085","vpu_orhe","VPU_ORHE_PRLEV","",$grAttr,$laAttr,$inAttr,$hardCode);
	echo $xtmp->currHtml;
...
//	echo $xtmp->currHtml;		
	...
	$inAttr = $xtmp->inAttrib;
	// $inAttr["size"] = "10";
	$xtmp->setFieldWrapper("view01","2.130","vsl_orhe","VPU_ORHE_ORVIA","",$grAttr,$laAttr,$inAttr,"");
//	echo $xtmp->currHtml;		
...
$hardCode =<<< EOC
	...
	<table  >
		<tr>
			<td >
				<input class="hidden" ng-model="VPU_ORHE_SHIPID" />
				{$xtmp->currHtml}
			</td>
			<td >	
	...
	<div id="SHIPVIALIST" class="hidden">
		<table style="width:100%;" class="{{vgb_cust_svia.length>0?'':'hidden'}} text-primary small ab-strong">
			<tr >
				<td style="width:60%;" >
					<span ab-label="VGB_PARTNERS_vgb_supp">Transp.</span>
				</td>
				<td style="width:30%;" >
		...
		<table style="width:100%;" class="table-striped" >
			...
			class="small ab-border ab-spaceless {{custdet.idVGB_SVIA==VPU_ORHE_SHIPID?'ab-strong':''}}" >
				<td style="width:60%;" >
					<span class="text-primary" ng-if="custdet.idVGB_SVIA==VPU_ORHE_SHIPID">
...
echo '</div><div class="col-sm-2  vslFormPg0 "  >';
	...
	$grAttr['class'] .= " hidden ";
	$laAttr = $xtmp->laAttrib;
	$laAttr["ab-label"] = "VGB_SUPP_BAORA";
	$inAttr = $xtmp->inAttrib;
...
<div class="row">
		<div class="col-sm-12 vslFormPg1 hidden " >
			<div class="row ">
...
$inAttr = $xtmp->inAttrib;
$inAttr["size"] = "10";
$laAttr["ab-label"] = "VSL_RELE_STPSQ";
...
$inAttr = $xtmp->inAttrib;
$inAttr["size"] = "5";
$laAttr["ab-label"] = "VPU_INDE_DDATE";
$hardCode = "<div class='invisible'>" . $xtmp->setDatePick("xxVPU_ORDE_DDATE"). "</div>";
...
<?php echo $headTd;?>
	...
	<strong><span ab-label="VPU_RELE_ORLIN" ></span><strong>&nbsp;
...
$xtmp->setFieldWrapper("view01","0.122","vsl_orst","y.VPU_ORST_ORDQT","",$grAttr,$laAttr,$inAttr,"");
$stepCode .= $xtmp->currHtml;
...
//	
//	$xtmp->setFieldWrapper("view01","0.122","vsl_orst","y.VPU_ORST_STEPS","",$grAttr,$laAttr,$inAttr,"");
//	$stepCode .= $xtmp->currHtml;
$stepCode .= '</td>';
...
<!--	
	<div ng-init="vsl_form_dta=vpu_orhe" >
		...
		<div class="modal-content">
			...
			<div class="modal-body ab-spaceless">
				...
				<div class="container" ng-if="1==0" title="AC Turning off" >
					<?php require_once "VPU_ORHE_ALLOCATION.php"; ?>
				</div>
