...
<select  class="ab-pointer" ng-init="getUsers();"
      ng-change="VSL_ORHE_USLNA=(x.specCurrent.length>0?x.specCurrent:'000');orderQuery();" 
...
$hardCode =<<<EOC
	...
	<div class="col-sm-5   {{vslFormPg==2?'':'hidden'}}" style="margin-left:5px;" >
	<div class="row well ab-spaceless" style="font-weight:900;" >
	<div class="col-sm-3 text-right ab-spaceless " >
		&nbsp;
		<span ng-if="stpSelName!=''">
			<small ng-if="DOC_ORST.length>0" class="{{stepRetract!=true?'bg-warning':'bg-danger'}} text-primary ab-pointer ab-border ab-spaceless" onclick="deflectVal('','DOC_ORST');$('[xlineSel]').val(false);" >
				&nbsp;Clear&nbsp;
			</small>
			&nbsp;
			<small ng-if="stpSelName!=''" ng-init="DOC_ORST=''" class="{{stepRetract!=true?'bg-warning':'bg-danger'}} text-primary ab-pointer ab-border ab-spaceless" onclick="deflectVal('','DOC_ORST');$('[xlineSel]').click();" >
				Select&nbsp;All&nbsp;
			</small>
		</span>
	</div>
	...
	<div  class="col-sm-2  text-left ab-pointer small text-primary  " style="padding-top:1px;"   >
	<input class="hidden ab-pointer" type="checkbox"  ng-model="stepRetract" ng-init="stepRetract=false;" />
		<span class="{{stepRetract!=true?'bg-warning':'bg-danger'}} ab-pointer ab-border ab-spaceless" ng-click="stepRetract=(stepRetract!=true?true:false)"  >
			&nbsp;Retract&nbsp; 
		</span>
...
<tr>
	<td >
	<span  class="ab-pointer" ng-click="test_01=1-test_01;"  onclick="$('#debugStat').toggleClass('hidden');">&nbsp;.&nbsp;</span>
	</td>
</tr>
<tr>
<td>
...
<div class="col-sm-10 vslFormPg2 ">
<div class="col-sm-12" title="">
<table class="" style="width:96%;" title="">
<tbody>
<tr>
<?php 
$headTd = '<td class="bg-primary" style="vertical-align:bottom;padding-left:4px;" >';
...
$xtmp->setFieldWrapper("view01","0.0","vsl_orde","VSL_ORHE_USLNA","",$grAttr,$laAttr,$inAttr,"");
echo $xtmp->currHtml;
echo '</td>';
...
$grAttr = $xtmp->grAttrib;
$laAttr = $xtmp->laAttrib;
$laAttr["ab-label"] = "VGB_CUST_DESCR";
$inAttr = $xtmp->inAttrib;
$inAttr["size"] = "7";

$xtmp->setFieldWrapper("view01","0.0","vsl_orde","VGB_CUST_DESCR","",$grAttr,$laAttr,$inAttr,"");
echo $xtmp->currHtml;
echo '</td>';
...
$xtmp->setFieldWrapper("view01","0.0","vsl_userVariance","VSL_ORHE_ORNUM","",$grAttr,$laAttr,$inAttr,"");
echo $xtmp->currHtml;
echo '</td>';
...
$xtmp->setFieldWrapper("view01","0.0","vsl_orde","VSL_ORHE_CUSPO","",$grAttr,$laAttr,$inAttr,"");
echo $xtmp->currHtml;
echo '</td>';
...
$grAttr = $xtmp->grAttrib;
$laAttr = $xtmp->laAttrib;
$laAttr["ab-label"] = "VSL_ORDE_ORLIN";
$inAttr = $xtmp->inAttrib;
$inAttr["size"] = "7";
...
$xtmp->setFieldWrapper("view01","0.0","vsl_orde","VSL_ORST_STPSQ","",$grAttr,$laAttr,$inAttr,"");
echo $xtmp->currHtml;
echo '</td>';
...
$xtmp->setFieldWrapper("view01","0.0","vsl_orde","VIN_ITEM_ITMID","",$grAttr,$laAttr,$inAttr,"");
echo $xtmp->currHtml;
echo '</td>';
...
$xtmp->setFieldWrapper("view01","0.0","vsl_orde","VIN_ITEM_DESC1","",$grAttr,$laAttr,$inAttr,"");
echo $xtmp->currHtml;
echo '</td>';
...
$grAttr = $xtmp->grAttrib;
$laAttr = $xtmp->laAttrib;
$laAttr["ab-label"] = "VSL_ORST_ORDQT";
$inAttr = $xtmp->inAttrib;
$inAttr["size"] = "7";

$xtmp->setFieldWrapper("view01","0.0","vsl_orde","VSL_ORST_ORDQT","",$grAttr,$laAttr,$inAttr,"");
echo $xtmp->currHtml;
echo '</td>';
...
$grAttr = $xtmp->grAttrib;
$laAttr = $xtmp->laAttrib;
$laAttr["ab-label"] = "VSL_ORST_PDATE";
$inAttr = $xtmp->inAttrib;
$inAttr["size"] = "7";

$xtmp->setFieldWrapper("view01","0.0","vsl_orde","VSL_ORST_PDATE","",$grAttr,$laAttr,$inAttr,"");
echo $xtmp->currHtml;
echo '</td>';
...
$inAttr = $xtmp->inAttrib;
$inAttr["size"] = "7";
$hardcode ="<label>VARIANCE</label>";
$xtmp->setFieldWrapper("view01","0.0","vsl_orde","xxVSL_ORDE_ORLIN","",$grAttr,$laAttr,$inAttr,$hardcode);
echo $xtmp->currHtml;
echo '</td>';
