...
<!--	
				<table>
					<tr><td style="width:50%;">&nbsp;</td><td style="width:50%;">AAAAA&nbsp;</td></tr>				
					<tr>
...
$xtmp = new appForm("VSL_ORHE");
							...
							?>
		  						...
		  						<tr ab-formlist="order_list"   ab-rowset="{{$index}}"   
...
?>
	...
	<tr>
		...
		<td colspan=100 class="ab-spaceless" >
			<table  class="table-condensed {{x.trash==1?'text-danger':''}} style="width:100%;vertical-align:top;" >
			<tr>
...
$laAttr["class"] = "hidden";
$inAttr["size"] = "5";
$hardCode = $xtmp->setYesNoField("VSL_ORDE_BAORA");
...
$laAttr["class"] = "hidden";
$inAttr["size"] = "5";
$hardCode = $xtmp->setYesNoField("VSL_ORDE_PACKP");
...
$hardCode = '<textarea rows="4" cols="20" ng-model="x.VSL_ORDE_ITEXT" class="ab-borderless" >This field will need to be added in vsl_orde  to replace legacy table vsl_ordr. </textarea>';
	...
	<table class=" ab-spaceless" style="width:100%;vertical-align:top;">
		<tr class="bg-primary" >
			...
			<td class="ab-spaceless" style="vertical-align:top;padding-left:2px;width:60px;">
								...
								<span class="ab-pointer" onclick="stepInsert(this);" >
									<span class="small" >Insert</span>
									<span  class="glyphicon glyphicon-pencil small" ></span>
								</span>			
			</td>
			...
			<td style="font-weight:700;" ab-label="VSL_ORST_STEPS">Seq. Steps&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		
		</tr>
		<tr  ab-formlist="orstep_list"  ordline="{{x.VSL_ORDE_ORLIN}}" ng-repeat="y in vsl_orhe | AB_Sorted:VSL_ORST_STPSQ | AB_Selected:x.VSL_ORDE_ORLIN:'VSL_ORDE_ORLIN'  " class="{{y.isSelected}} ab-spaceless  " 
		ng-if="y.isSelected!='hidden'" >
...
$xtmp->setFieldWrapper("view01","0.122","vsl_orst","y.VSL_ORST_PDATE","",$grAttr,$laAttr,$inAttr,"");
$stepCode .= $xtmp->currHtml;
$stepCode .= '</td>';
