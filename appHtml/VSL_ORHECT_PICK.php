...
<div 	class=" row " 
	ng-repeat="curRow in  rawResult.vsl_pick | AB_noDoubles:'idVSL_ORHE,VSL_ORST_PICID'"
	ng-if="curRow.VSL_ORST_PICID==orderSelected"
 >
	...
	<tr>
		<td class=" ab-spaceless text-top" >	
			<div ng-click="ACVarDivToggle(x.idVSL_ORDE);" class="ab-pointer" >
				...
				<td style="white-space:nowrap;" class="ab-strong text-right {{x.VSL_ORDE_OTEXT.trim().length>0?'text-danger':' text-primary'}}" >
					<span class="caret"></span>
					<span class=" small" ng-click="" >...</span>
				</td>
				</tr>
				</table>
...
-->		
			...
			>
				...
				<div class="ab-border ab-spaceless " style="min-width:25px;min-height:16px;" >
					...
					<span ng-repeat="lotRows in vsl_orheLSTR | AB_noDoubles:'idVSL_ORHE' " ng-if="lotRows.idVSL_ORHE==idVSL_ORHE" >
...
<div class="col-sm-12" >
	...
	<div ng-if="$last==true" ng-init="setFormPickOn(x.VSL_ORST_PICID);"  >...</div>
	</div>
