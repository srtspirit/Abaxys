...
?>
<div class='btn-sm ab-body-buttons' >
	...
	<div class="col-sm-12" >
		<table class="table" >
			<tr>
				...
				<span ab-empty="{{tbData=='vgb_cust'?'vgb_cust':'Yes'}}" class="btn btn-xs btn-default" onclick="abLink(this);" href="#VGB_PARTNERS/VGB_CUSTCT/Process:VGB_PARTNERS,Session:VGB_CUSTCT,tblName:vgb_cust,updType:CREATE,idVGB_BPAR:0" >New Customer</span>
				<span ab-empty="{{tbData=='vgb_supp'?'vgb_supp':'Yes'}}" class="btn btn-xs btn-default" onclick="abLink(this);" href="#VGB_PARTNERS/VGB_SUPPCT/Process:VGB_PARTNERS,Session:VGB_SUPPCT,tblName:vgb_supp,updType:CREATE,idVGB_BPAR:0" >New Supplier</span>
			...
			<tr  role="presentation"  ng-repeat="x in vgb_bpar">
				...
				<div class="rows">
					...
					<div class="col-sm-2">			
						...
						<span class="btn-sm table-bordered"  recid={{x.VGB_BPAR_BPART}} onclick="$('[ab-fxVGB_CUST_ADDRS]').toggleClass('ab-hidden');">
				          		
				          		<span class="text-muted" ab-label="STD_ADDRESS" >
								Addr
							</span>	
							&nbsp;&nbsp;
						...
						<span ab-fxVGB_CUST_ADDRS ab-label="STD_DETAILLED" class='btn btn-xs text-muted ab-hidden' onclick="$('[ab-fxVGB_CUST_ADDRSde]').toggleClass('ab-hidden');" >Detail</span>
				...
				<div  class="col-sm-8 ab-hidden" ab-fxVGB_CUST_ADDRS ab-fx ab-dtaGB_CUST_BKADD>
				      	<table class='table table-hover btn'  >
				      	
				      	<tr ng-repeat="y in x.rowSet" ab-value='{{y.idVGB_ADDR}}' 
				      	onclick="deflectVal(this.getAttribute('ab-value'),'VGB_CUST_BKADD');$('[ab-fxVGB_CUST_ADDRS]').toggleClass('ab-hidden');">
						<td>
							{{y.VGB_ADDR_ADDID}}
						</td>
						<td style='text-align:left;white-space:nowrap;'  >
							...
							{{ y.VGB_ADDR_DESCR }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<br>
							<span ab-fxVGB_CUST_ADDRSde class='ab-hidden btn-sm disabled'>
								{{y.VGB_ADDR_ADNAM}} 
								<br>{{y.VGB_ADDR_ADD01}},  
								{{y.VGB_ADDR_ADD02}} 
