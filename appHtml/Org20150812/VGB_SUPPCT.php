	...
	<div class="col-sm-6">
		...
		<tr>
			...
			<td >
				...
				<span class="btn-sm table-bordered"  onclick="$('[ab-fxVGB_SUPP_BTADD]').toggleClass('ab-hidden');">
		          		...
		          		<span class="text-muted" ng-repeat="x	in vgb_supp">
				...
				<span ab-fxVGB_SUPP_BTADD ab-label="STD_DETAILLED" class='btn btn-xs text-muted ab-hidden' onclick="$('[ab-fxVGB_SUPP_BTADDde]').toggleClass('ab-hidden');" >Detail</span>
				...
				<div  class="ab-search ab-hidden" ab-fxVGB_SUPP_BTADD ab-fx ab-dtaGB_CUST_BTADD>
				      	...
				      	<tr ng-repeat="y in vgb_supp" ab-value='{{y.idVGB_ADDR}}' 
		...
		<tr>
			...
			<td >
				...
				<span ab-fxVGB_SUPP_STADD ab-label="STD_DETAILLED" class='btn btn-xs text-muted ab-hidden' onclick="$('[ab-fxVGB_SUPP_STADDde]').toggleClass('ab-hidden');" >Detail</span>
