...
<div class='btn-sm ' id="ab-header" style="white-space:nowrap;">
...
<div class="row mygrid-wrapper-div">
	<div class="col-sm-5">
		...
		<td onclick="if(A_ReporterFn.getProp()){}">
			...
			<label class="btn-md {{vgb_bpar.tbData=='vgb_cust'?'':'hidden'}}" ab-label="VGB_CUST_BPART">Partner</label>
			<label class="btn-md {{vgb_bpar.tbData=='vgb_supp'?'':'hidden'}}"  ab-label="VGB_SUPP_BPART">Partner</label>
		...
		<td>
			<div class="row">
				<div class="col-sm-12">
					...
					<span class="{{VGB_ADDR_BPART>0?'':'hidden';}}">
						<label >{{VGB_BPAR_BPART}}</label>
						&nbsp; {{VGB_BPAR_BPNAM}}
					</span>
				</div>
			</div>
			<div class="row {{VGB_ADDR_BPART>0?'hidden':'';}}">
				<div class="col-sm-3">
				...
				<div class="col-sm-9">
					<input a_iref="02-60"
						...
						readonly
						lval=""
						ng-keypress="A_chkRec('VGB_BPAR_BPART','vgb_bpar',$event,'keypress,13');"
						ng-blur="A_chkRec('VGB_BPAR_BPART','vgb_bpar',$event,'blur');"
						ng-model="vgb_bpar.VGB_BPAR_BPART" 
						name="VGB_BPAR_BPART" 
						value="" 
					/>
				</div>
			...
			<div class="row {{VGB_ADDR_BPART>0?'hidden':'';}}">
				...
				<div class="col-sm-9">
					...
					<input a_iref="02-60"
						size=25
						lval=""
						ng-keyup="VGB_ADDR_ADNAM=vgb_bpar.VGB_BPAR_BPNAM"
						ng-model="vgb_bpar.VGB_BPAR_BPNAM" 
						name="VGB_BPAR_BPNAM" 
						value="" 
					/>
		...
		<td>
			<div><table><tr>
				...
				<input a_iref="02-60"
					size=2
					type="{{VGB_ADDR_BPART>0?'text':'hidden';}}"
					lval=""
				...
				<input 
					size=2
					type="{{VGB_ADDR_BPART>0?'hidden':'text';}}"
					lval=""
					ng-model="VGB_ADDR_ADDID" 
					value="" 
				/>			
	...
	<div class="col-sm-7">
		...
		<div>
			...
			<td >
				<div>
				<span class="text-muted" role="presentation" ng-model="VGB_ADDR_SCHID_f1X2" ng-repeat="x in vgb_addr | AB_Compare:VGB_ADDR_SCHID:'idVTX_SCHH'">
		...
		<td class="ab-align-top">
			...
			<td alain>
				...
				<div>
				<span class="text-muted" role="presentation" ng-model="VGB_ADDR_PCHID_f1X2" ng-repeat="x in vgb_addr | AB_Compare:VGB_ADDR_PCHID:'idVTX_SCHH'">
