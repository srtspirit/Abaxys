...
<div style="margin-left:5px;" >	  			
		<div class="row">
			...
			<form id="mainForm" name="mainForm"  ab-context="1" ab-view="vsl_orhe" ab-main="vsl_orhe" class="well"  >			
			<div class="col-sm-3  ac">
				...
				<input  class="hidden" ng-init="VGB_CURR_CURID = ' ';ABlstAlias('VGB_CURR_CURID','VGB_CURR_CURID','vgb_curr',0);" ng-model="VGB_CURR_CURID" />
...
$harderCode = <<<EOB
        ...
        >
        	<td style="text-align:left;white-space:nowrap;">
       			...
       			<span>&nbsp;</span>
       			<div class="small well ab-spaceless">
	       			<table>
...
$hardCode .= '<td style="vertical-align:top;" ><label class="text-primary"  ab-label="STD_TEXT_LINE" >Text Line</label>:<textarea style="overflow:hidden;font-size:9pt;" rows="4" cols="30"  ng-model="VSL_ORHE_ORTXT"  > </textarea></td><td>&nbsp;&nbsp;&nbsp;</td>';
