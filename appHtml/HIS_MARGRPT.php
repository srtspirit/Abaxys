...
<div class="row text-primary ab-strong">
	...
	<div class="col-lg-2">
		<?php
			...
			// echo  $hardCode;
		?>
		<input size=20 ng-model="listerData" />
	</div>
	<div class="col-lg-2">
		<span class="btn btn-success btn-md ab-spaceless" ab-label="STD_SUBMIT" ng-click="callLister();" >GO</span>
	</div>
	<div class="col-lg-4">
		<span ng-repeat="xx in Andrey">{{xx.name}}-</span>
	</div>
</div>
