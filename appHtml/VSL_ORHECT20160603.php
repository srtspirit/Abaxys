...
<input class="hidden" ng-model="idVIN_ITEM" />
		...
		<div class="col-sm-8 ">
			<div class="row">
				<div class="col-sm-6 center-block">
					  		<div title="" class="{{ opts.updType!='CREATE'?'':'hidden' }}" ng-init="collaps=0" style="padding-left:100px;" >
				...
				<div class="col-sm-6" ng-init="vin_inveQuery=''" >
					Allocation:
					<span 	
						class="btn btn-link glyphicon glyphicon-search ab-spaceless" 
						data-toggle="modal" data-target="#ORHE_ALLOC"  title="">
					</span>	
...
// $hardCode .= '<span id="inveRefr" class="btn glyphicon glyphicon-refresh text-primary " style="font-size:8pt;" ng-click="inveRefresh();initAddress();"></span></span>';
$xtmp->setFieldWrapper("view01","0.0","vsl_orde","xxVSL_ORDE_ORDQT","",$grAttr,$laAttr,$inAttr,"");
echo $headTd;
echo '<table><tr><td><span id="inveRefr" title="refresh" class="glyphicon glyphicon-refresh ab-pointer" style="font-size:8pt;" ng-click="inveRefresh();initAddress();"></span>&nbsp;</td><td>';
		...
		<tr class="bg-primary small" >
			...
			<td style="font-weight:700;width:30%;" class="text-right  " >&nbsp;
			 <span ng-if="x.VIN_ITEM_LOTCT > 0">
				Spec.:	
			      <select class="bg-primary" ng-options="spc.idVIN_SSMA as spc.VIN_SSMA_SPEID for spc in specSheet[x.idVIN_ITEM] | AB_noDoubles:'idVIN_SSMA' " 
		...
		<div class="row "   
			...
			<div class="col-sm-1 ab-border ab-spaceless text-center">
				{{ ABGetDateFn('get-year',lotQt.VIN_LSHE_DATES) }}-{{ ABGetDateFn('get-month',lotQt.VIN_LSHE_DATES) }}
							...
							<div ng-if="!x.specCurrent" class="col-sm-2  ab-spaceless" >			
								...
								<td style="width:34%;"  class=" ab-border ab-spaceless text-center small">
									...
									{{ (ABGetDateFn('diff-today',lotQt.VIN_LSHE_DATES)/12).toFixed(1) }}
									</span>
...
-->
			...
			<div ng-if="x.specCurrent" class="col-sm-2  ab-spaceless" >
				...
				<table style="width:100%;" >
					...
					<td class="ab-border ab-spaceless text-center" style="width:34%;" >
						{{ ABGetDateFn('diff-perc',lotQt.VIN_LSHE_DOMDA + "," + sp.VIN_LSHE_DATES) }}%
					</td>
					<td class="ab-border ab-spaceless text-center" style="width:33%;" >
