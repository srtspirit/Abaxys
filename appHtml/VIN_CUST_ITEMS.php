...
<div class="hidden" ng-init="SESSION_DESCR='Customer items';idVIN_ITEM=0;hideEmptyCust=0;ABlstAlias('idVIN_ITEM','idVIN_ITEM','vin_cust_item','vin_cust');" >
...
$xtmp->setFieldWrapper("view01","0.0","vin_cust","VIN_CUST_QUONU","",$grAttr,$laAttr,$inAttr,$hardCode);
echo $xtmp->currHtml;
...
?>
					...
					<input type="radio"  name="Items"  ng-click="hideEmptyCust=1" />&nbsp;Customer Items
					&nbsp;&nbsp;
...
?>
	...
	<div class="row bg-primary " ng-init="extraSort='';sortBy='VGB_CUST_DESCR';"  >
	<div class="ab-wrapper-div">
		...
		<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12 text-left ab-spaceless"  >
			<table class="ab-spaceless small" >
				<tr>
		...
		<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12 ab-spaceless" ><?php echo setHeadField("VGB_SUPP_DESCR","10","Supplier","1","1","","bg-primary"); ?></div>
        	<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12 ab-spaceless"  ><?php echo setHeadField("VIN_CUST_SELLP","10","Sell Price","","","","bg-primary"); ?></div>        
		<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12 ab-spaceless"  ><?php echo setHeadField("VIN_CUST_EXPIR","10","Expiry Date","1","-1","","bg-primary"); ?></div>
		<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12 ab-spaceless"  ><?php echo setHeadField("VIN_CUST_LPPAID","10","Last Price","","","","bg-primary"); ?></div>
		<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12 ab-spaceless"  ><?php echo setHeadField("VIN_CUST_LPDATE","10","Date","","","","bg-primary"); ?></div>
	</div>
	</div>	
			<div class="ab-wrapper-div"> 
		<div class="row {{varRow.rowRowLog.hidden}} ab-odd ab-spaceless  " id="rNum{{varRow.abIndex}}" 
			ng-repeat="varRow in  rawResult.vin_cust | AB_noDoubles:'idVIN_ITEM,idVIN_CUST' | AB_sortReverse:extraSort+sortBy " 
			ng-if="hideEmptyCust!=1||varRow.idVIN_CUST>0" 
			>	

			<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12  " ng-if="varRow.VIN_CUST_BPART>0">
				<table style="width:100%;" >
					<tr>
						...
						<td>
							...
							<a href="#VIN_ITEMS/VIN_CUSTCT/idVIN_CUST:{{varRow.idVIN_CUST}},tblName:vin_cust,updType:UPDATE,Session:VIN_CUSTCT,Process:VIN_ITEMS,idVIN_ITEM:{{varRow.idVIN_ITEM}},idVGB_CUST:{{varRow.VIN_CUST_BPART}}">
								<span class="glyphicon glyphicon-pencil"></span>
							</a>			
						</td>		
			...
			<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12  " ng-if="!varRow.idVIN_CUST">
				<table style="width:100%;" >
					<tr>
						<td style="width:30%;"  class="text-left visible-xs visible-md  visible-sm ">
							<?php echo setHeadField("VGB_BPAR_BPART","10","Customer","","",""," text-primary visible-xs visible-md  visible-sm "); ?>
					    ...
					    <td>
							...
							<a href="#VIN_ITEMS/VIN_CUSTCT/idVIN_CUST:0,tblName:vin_cust,updType:CREATE,Session:VIN_CUSTCT,Process:VIN_ITEMS,idVIN_ITEM:{{varRow.idVIN_ITEM}},idVGB_CUST:{{varRow.VIN_CUST_BPART}}">
								<span class="glyphicon glyphicon-pencil"></span>
							</a>			
						</td>				
						
						<td>	
							Add new customer to Item.		
						</td>
					</tr>
				</table>
			</div>
			
			<div class="hidden col-lg-1 col-md-4 col-sm-6 col-xs-12  " ng-if="!varRow.idVIN_CUST">
				<table style="width:100%;" >
					<tr>
						<td style="width:30%;"  class="text-left visible-xs visible-md  visible-sm ">
			...
			<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12  " ng-if="varRow.VIN_CUST_BPART>0">
				<table style="width:100%;" >
					<tr>
						...
						<td>
							<?php echo setRowDspField("varRow.VGB_CUST_BPNAM","10","Name","","","","  "); ?>
						</td>
					</tr>
				</table>
			</div>
			...
			<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12 " >
				...
				<table style="width:100%;" >
					<tr>
						...
						<td>
							<?php echo setRowDspField("varRow.VIN_ITEM_DESC1","10","Description","","","","  "); ?>
						</td>
					</tr>
				</table>
			</div>
				...
				<table style="width:100%;" >
					<tr>
						<td style="width:30%;" class="text-left visible-xs visible-md  visible-sm ">
							<?php echo setHeadField("VIN_CUST_UBPDE","5","Use client","","",""," text-primary visible-xs visible-md  visible-sm "); ?> 
						</td>
						
						<td style="width:35%;white-space:nowrap;">
							<div><table><tr>
							<td><span class="small text-primary visible-xs visible-md  visible-sm ">Code:&nbsp;</span></td>
							<td><?php  echo $xtmp->setYesNoDisplay("varRow.VIN_CUST_UBPDE"); ?></td>
							</tr></table></div>
						...
						<td style="width:35%;white-space:nowrap;">	
							<div><table><tr>
							<td><span class="small text-primary visible-xs visible-md  visible-sm ">Desc:&nbsp;</span></td>
							<td><?php echo $xtmp->setYesNoDisplay("varRow.VIN_CUST_UBPCO"); ?></td>
							</tr></table></div>
			...
			<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12  " ng-if="varRow.VIN_CUST_ACTYP=='SUPP'">
				<table style="width:100%;" >
					<tr>
						<td style="width:30%;"  class="text-left visible-xs visible-md  visible-sm ">
						...
						<td>
							<?php echo setRowDspField("varRow.VGB_SUPP_BPNAM","10","Name","","","","  "); ?>
						</td>
					</tr>
				</table>
			</div>
			...
			<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12  " ng-if="varRow.VIN_CUST_ACTYP=='CUST'">
				<table style="width:100%;" >
					<tr>
						<td style="width:30%;"  class="text-left visible-xs visible-md  visible-sm ">
							<?php echo setHeadField("VGB_SUPP_DESCR","10","Name","","",""," text-primary visible-xs visible-md  visible-sm "); ?> 
			...
			<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12  " >
				...
				<table style="width:100%;" >
					<tr>
						<td style="width:30%;"  class="text-left visible-xs visible-md  visible-sm ">
							<?php echo setHeadField("VIN_CUST_EXPIR","5","Expiry Date","","",""," text-primary visible-xs visible-md  visible-sm "); ?> 
							
						</td>
						
						<td>			
							<?php echo setRowDspField("varRow.VIN_CUST_EXPIR","10","Expiry Date","","","","  "); ?>
						</td>
					</tr>
				</table>
			</div>		
			...
			<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12  " >
				...
				<table style="width:100%;" >
					<tr>
						<td style="width:30%;"  class="text-left visible-xs visible-md  visible-sm ">
							<?php echo setHeadField("VIN_CUST_LPPAID","5","Last Price","","",""," text-primary visible-xs visible-md  visible-sm "); ?> 
							
						</td>
						
						<td>			
							<?php echo setRowDspField("varRow.VIN_CUST_LPPAID","5","Last Price","","","","  "); ?>
						</td>
					</tr>
				</table>
			</div>		
			...
			<div class="col-lg-1 col-md-4 col-sm-6 col-xs-12  " >
				...
				<table style="width:100%;" >
					<tr>
						<td style="width:30%;"  class="text-left visible-xs visible-md  visible-sm ">
							<?php echo setHeadField("VIN_CUST_LPDATE","5","Date","","",""," text-primary visible-xs visible-md  visible-sm "); ?> 
							
						</td>
						
						<td>			
							<?php echo setRowDspField("varRow.VIN_CUST_LPDATE","10","Date","","","","  "); ?>
						</td>
					</tr>
				</table>
			</div>		
	...
	<div class="row mygrid-wrapper-div" ng-re2peat="varRec in  vin_cust" ng-init="extraSort='';sortBy='VIN_CUST_BPART';">	
	</div> 
